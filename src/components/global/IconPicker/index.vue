<template>
    <a-input v-model:value="icon" allow-clear @change="emit('update:icon', icon)" :disabled="disabled">
        <template #addonAfter>
                ...
                <template v-slot:content>
                    <div :style="{ width: '340px', height: '250px', overflow: 'auto' }">
                        <div class="grid grid-cols-8 gap-2 p-1">
                            <div v-for="item in getPaginationList" :key="item" @click="fontClick(item)"
                    ...
                    <div class="pt-2 text-center">
                        <a-pagination :showSizeChanger="false" show-less-items class="w-[100%]" :total="getTotal"
