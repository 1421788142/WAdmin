...
const chnageDark = (value: boolean) => {
  !switchDarkFn && import('@/hooks/useTheme').then(({ useTheme }) => {
...
<template>
  <div class="relative w-screen h-screen dark:bg-[#333]">
    ...
    <div class="absolute top-0 left-0 flex items-center justify-center w-screen h-screen">
      <div
        class="w-[95%] rounded-xl h-[95%] shadow-2xl bg-gradient-to-r from-green-400 to-blue-500 dark:from-[#464646] dark:to-[#232323] flex justify-between items-center">
        <div class="w-[60%] h-[100%] p-20 items-center hidden xl:flex justify-center">
          <img :src="getAssets('image/login_left.png')" alt="login" />
        </div>
        <div class="w-[100%] xl:w-[50%] h-[100%] px-2 flex items-center justify-center">
          <div
            ...
            <div class="flex items-center justify-center mb-10">
              <img class="max-w-[70px] mr-[5%]" :src="getAssets(VITE_PROJECT_LOGO)" />
